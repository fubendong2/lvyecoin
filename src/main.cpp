...
int64 nChainStartTime = 1395327992;
...
const string strMessageMagic = "Lvyecoin Signed Message:\n";
...
bool CBlock::AddToBlockIndex(unsigned int nFile, unsigned int nBlockPos)
{
	...
	//printf("pindexNew->nStakeModifierChecksum  == %s\n", pindexNew->nStakeModifierChecksum.ToString().c_str());
	if (!CheckStakeModifierCheckpoints(pindexNew->nHeight, pindexNew->nStakeModifierChecksum))
		//return error("AddToBlockIndex() : Rejected by stake modifier checkpoint height=%d, modifier=0x%s"PRI64x, pindexNew->nHeight, pindexNew->nStakeModifierChecksum);
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	if (mapBlockIndex.empty())
	{
		...
		// Genesis block
		const char* pszTimestamp = "lvyecoin huopool coin";
		CTransaction txNew;
		...
		assert(block.hashMerkleRoot == uint256("0x1fe314503fc8a27aaa0d4dc134c0fc5096582f0d81f26a9b00d7249eb5b29b39"));
		block.print();
