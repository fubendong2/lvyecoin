...
After completing windows setup then run windows command line (cmd)
  cd daemon
  Lvyecoind
You would need to create a configuration file Lvyecoin.conf in the default
wallet directory. Grant access to Lvyecoind.exe in anti-virus and firewall
...
Lvyecoind backupwallet <destination_backup_file>
Then shutdown ppcoind by
Lvyecoind stop
Start up the new Lvyecoind (0.3.0).
